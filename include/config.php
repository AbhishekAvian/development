...
define('site_url', 'https://webdev24x7.com/aviva-signature-guranteed-income-plan');
define('theme_url', 'https://webdev24x7.com/aviva-signature-guranteed-income-plan/asset/designers');
define('site_admin',site_url."/admin");
//phpinfo();
