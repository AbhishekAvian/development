          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Monthly Leads (<?php echo getDateFormat($one_month,9);?> - <?php echo getDateFormat($date,9);?>)
              </h3>
...
-->
                    ...
                    <table id="data" class="table table-bordered" width="100%">
                      ...
                      <tbody>
                          <?php 
                          $i = 1;
                          while($result = mysqli_fetch_array($monthlead)){?>
                        <tr class="table-hover table-striped">
                          ...
                          <td> <?php echo getDateFormat($result['posted_date_hrs'],7);?> </td>
                        </tr>
                          <?php } ?>
                          </tbody>
                    </table>
                          <?php } else { ?>
                <div class="alert alert-danger">Oops! No Leads Found between (<?php echo getDateFormat($one_month,9);?> - <?php echo getDateFormat($date,9);?>)</div>
                          <?php } ?>
                      </div>
                  </div>
                </div>
