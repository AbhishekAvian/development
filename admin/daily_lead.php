...
-->
                    ...
                    <table id="data" class="table table-bordered" width="100%">
                      ...
                      <tbody>
                          <?php 
                          $i = 1;
                          while($result = mysqli_fetch_array($todaylead)){?>
                        <tr class="table-hover table-striped">
                         ...
                         <td> <?php echo getDateFormat($result['posted_date'],9);?> </td>
                        </tr>
                          <?php } ?>
                          </tbody>
                    </table>
    ...
    <div class="alert alert-danger">Oops! No Leads Found for "<?php echo getDateFormat($date,3);?>"</div>
<?php } ?>
                      </div>
                  </div>
                </div>
