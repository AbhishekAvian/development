          ...
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title">
                ...
                </span> Weekly Leads (<?php echo getDateFormat($one_week,9);?> - <?php echo getDateFormat($date,9);?>)
              </h3>
...
-->
                    ...
                    <table id="data" class="table table-bordered" width="100%">
                      ...
                      <tbody>
                          <?php 
                          $i = 1;
                          while($result = mysqli_fetch_array($weeklead)){?>
                        <tr class="table-hover table-striped">
                          ...
                          <?php } else { ?>
                <div class="alert alert-danger">Oops! No Leads Found between (<?php echo getDateFormat($one_week,9);?> - <?php echo getDateFormat($date,9);?>)</div>
                          <?php } ?>
                      </div>
                  </div>
                </div>
